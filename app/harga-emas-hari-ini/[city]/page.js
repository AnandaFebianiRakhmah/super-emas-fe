  ...
  return (
    <>
      ...
      <main className="location-page">
        ...
        <section className="location-info-section"><div className="container"><h2>Informasi Cabang {location.name}</h2><div className="location-info-card"><div className="location-detail"><FaMapMarkerAlt className="location-icon" /><div><h3>{location.fullName}</h3><p>{location.address}</p><p className="service-area">{location.content.serviceArea}</p><p className="service-area">Jam operasional: Setiap hari, 09.00-20.00</p></div></div><a href={location.mapUrl} target="_blank" rel="noopener noreferrer" className="maps-button"><FaMapMarkerAlt /> Lihat di Google Maps</a></div></div></section>
