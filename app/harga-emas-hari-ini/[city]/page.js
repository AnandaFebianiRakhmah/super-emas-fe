  ...
  return (
    <>
      ...
      <main className="location-page">
        ...
        <section className="location-hero"><div className="container"><h1 className="location-h1">{location.seo.h1}</h1><p className="location-intro">{location.content.intro}</p><div className="operating-hours-important"><FaClock /> <span><strong>Informasi penting:</strong> Jam operasional setiap hari, 09.00-20.00</span></div></div></section>
